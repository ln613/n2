...
const Convert = ({ file, selectFile, convert, inProgress, folder, setFolder, name, setName }) =>
  <div>
    <div>
    ...
    <div class="mt8">
      <Button primary onClick={() => convert(file, folder, name)} disabled={!file || inProgress}>Convert &amp; Upload</Button>
...
export default compose(
  ...
  withHandlers(({
    ...
    convert: ({ setInProgress }) => async (file, folder, name) => {
      tap(folder); tap(name);
      setInProgress(true);
